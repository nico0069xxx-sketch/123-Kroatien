...
templates/ ├── include/ │ ├── base.html # Haupt-Layout (Navbar, Footer, Cookie-Banner) │ ├── footer.html │ └── card_*.html # Immobilien-Karten ├── account/ # Login, Signup, Password Reset ├── main/ # Hauptseiten ├── glossary/ # Glossar-Seiten ├── legal/ # Rechtliche Seiten ├── makler_portal/ # Makler-Dashboard └── professional_portal/ # Professionals-Dashboard
...
real-estate-django-main/ ├── accounts/ # Benutzer-Verwaltung ├── contacts/ # Kontaktformulare ├── listings/ # Immobilien-Anzeigen ├── main/ # Hauptlogik │ ├── glossary_.py # Glossar-System │ ├── professional_.py # Professional-System │ ├── makler_views.py # Makler-Portal │ └── middleware/ # Custom Middleware ├── pages/ # Statische Seiten ├── realtors/ # Makler (Legacy) ├── realstate/ # Django Settings ├── static/ # CSS, JS, Images ├── templates/ # HTML Templates ├── locale/ # Übersetzungen ├── fixtures/ # Seed-Daten └── manage.py
...
*Python Version: 3.8+*# 🏠 PROJEKT-SITEMAP & ÜBERSICHT
## Kroatien Immobilienportal (123-kroatien.eu)
**Stand:** Dezember 2024 | **Django 4.2.1** | **12 Sprachen**
