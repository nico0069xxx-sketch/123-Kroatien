...
urlpatterns = content_urlpatterns + [
    ...
    path('ge/kroatien/experten-finder/', matching_views.matching_page, {'lang': 'ge'}, name='experten-finder-ge'),
    path('hr/hrvatska/pronalazac-strucnjaka/', matching_views.matching_page, {'lang': 'hr'}, name='experten-finder-hr'),
    ...
    path('service', views.service, name='service-no-slash'),
    ...
    # Partner & Registration - spezifische URLs VOR generischen
    ...
    # Glossar DE - VOR generischen category URLs
    ...
    # Generische Category Routes - MÜSSEN GANZ AM ENDE STEHEN!
