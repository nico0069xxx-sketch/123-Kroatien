    ...
    try:
        ...
        if translated_title and translated_desc:
            json_content = {
                ...
                "property_type": property_type_translations.get(target_lang, {}).get(listing.property_type, listing.property_type),
...
def home(request):
    # Sprache aus URL-Pfad extrahieren
    path = request.path
    ...
    for listing in latest_8_listings:
        if user_language == 'ge': listing.json_content = get_or_create_translation(listing, "ge", "german_content")
        elif user_language == 'fr': listing.json_content = get_or_create_translation(listing, "fr", "french_content")
        elif user_language == 'gr': listing.json_content = get_or_create_translation(listing, "gr", "greek_content")
        elif user_language == 'hr': listing.json_content = get_or_create_translation(listing, "hr", "croatian_content")
        elif user_language == 'pl': listing.json_content = get_or_create_translation(listing, "pl", "polish_content")
        elif user_language == 'cz': listing.json_content = get_or_create_translation(listing, "cz", "czech_content")
        elif user_language == 'ru': listing.json_content = get_or_create_translation(listing, "ru", "russian_content")
        elif user_language == 'sw': listing.json_content = get_or_create_translation(listing, "sw", "swedish_content")
        elif user_language == 'no': listing.json_content = get_or_create_translation(listing, "no", "norway_content")
        elif user_language == 'sk': listing.json_content = get_or_create_translation(listing, "sk", "slovak_content")
        elif user_language == 'nl': listing.json_content = get_or_create_translation(listing, "nl", "dutch_content")
        else: listing.json_content = get_or_create_translation(listing, "en", "english_content")
...
def agent(request, id):
    ...
    for listing in listings:
        ...
        elif user_language == "en": listing.json_content = get_or_create_translation(listing, "en", "english_content")
